...
![Components](https://github.com/user-attachments/assets/d6a7a7a4-f10e-4df1-9c4f-b4a1a8db7f0e) <img src="https://github.com/user-attachments/assets/43785072-53b2-460b-87f2-fa05801371f3" />  
...
![Last Update](https://github.com/user-attachments/assets/e1d05f21-2a01-4ecf-94f3-b7bdff4d44dd) <img src="https://github.com/user-attachments/assets/78ee01ea-5cad-4b40-9527-b813899eb9c4" />  
...
* StartMouseHook function is typically a user-defined custom wrapper used to initialize a Windows mouse hook via SetWindowsHookEx, utilizing parameters like WH_MOUSE or WH_MOUSE_LL (low-level) to monitor mouse activity globally or locally.
  ...
  * ```DLL injection```  
    (if used): If your shell hook is intended to operate globally within a DLL, that DLL must also be a 64-bit DLL, because 64-bit processes cannot load 32-bit DLLs (and vice versa).
...
### :speech_balloon: C++ Virtual method Sample Code:
```c++
#include <iostream>
#include "windows.h"
